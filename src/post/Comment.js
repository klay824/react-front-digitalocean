...
class Comment extends Component {
    ...
    isValid = () => {
        ...
        if (!text.length > 0 || text.length > 150) {
            this.setState({
                error: "Comments should be between 1 - 150 characters long."
            });
            return false;
        }
        return true;
    ...
    deleteConfirmed = (comment) => {
        let answer = window.confirm("Are you sure you want to delete this comment? This cannot be undone.");
        if (answer) {
    ...
    render() {
        ...
        return (
            <div className="container">
                <h2 className="mb-5 mt-5">Leave A Comment</h2>
                <form onSubmit={this.addComment}>
                    <div className="row">
                        ...
                        />
                        <button className="btn btn-raised btn-info ms-1 col-md-2">
                            Post
                        </button>
                    </div>
                </form>
                ...
                <div
                    className="alert mt-2 alert-danger"
                ...
                <div className="col-md-12 col-md-offset-2">
                    <h3 className="text-info mt-2">{comments.length} Comments</h3>
                    <hr />
